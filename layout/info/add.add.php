...
//        echo $date;
    ...
    if (mysqli_num_rows($result) == 0) {
        $insert = "INSERT INTO extradata (CursusID, CursusonderdeelID, Lunch, Subsidie, Certificaten, Gefactureerd, Uitnodigingen, exameninstantie) values('$cid', '$coid', '$Lunch', '$selectSubsidie', '$selectCertificaten', '$selectGefactureerd', '$Uitnodigingen', '$Exameninstantie')";
        ...
        $update = "UPDATE extradata SET Lunch='$Lunch', Subsidie='$selectSubsidie', Certificaten='$selectCertificaten', Gefactureerd='$selectGefactureerd', Uitnodigingen='$Uitnodigingen', exameninstantie='$Exameninstantie' WHERE CursusID = '$cid' and CursusonderdeelID = '$coid'";
