...
// code om de waarden van de gegevens te pakken aan de hand van de volgende id's cursus id, cursusonderdeel id en docent id
    ...
    if ($bid == '') {
        ...
        $where = 'WHERE P.deleted = 0 AND C.CursusID = ' . $cursusid . ' and CO.CursusOnderdeelID = ' . $coid;

    } else {

        $where = 'WHERE P.deleted = 0 AND C.CursusID = ' . $cursusid . ' and CO.CursusOnderdeelID = ' . $coid . ' AND CB.BedrijfID = ' . $bid;
